<footer id="footer" class="module footer bg-footer bg-no-repeat bg-cover w-full relative bottom-0 md:h-230 lg:h-193 xl:h-217 2xl:h-241 md:px-51 2xl:px-161 md:-mt-50 2xl:-mt-70">
  <div class="flex md:flex-col lg:flex-row md:pt-88 md:items-center xl:pt-120 2xl:pt-139">
    <div class="">
      <img class="w-113" src="{!! App::getLogoFooter()['url'] !!}" alt="{!! App::getLogoFooter()['alt'] !!}">
    ...
    <div class="md:mt-18 flex flex-col xl:flex-row md:md:items-center w-full lg:items-end xl:md:justify-between xl:ml-75 xl:mr-40">
      <div class="flex lg:order-2 xl:order-1 md:justify-between lg:w-4/5 xl:w-3/5 lg:mt-20">
        <small>ORCHESTRA SITE</small>
        <small>ENCOMPASS WEBSITE</small>
        <small>HANDOFF WEBSITEM</small>
      </div>
      <button class="md:mt-11 rounded-3xl px-28 py-7 ring ring-white lg:order-1 xl:order-2">
        CONTACT
      </button>
    </div>
  </div>
  ...
  <!-- <class="row">
      <ul class="list-none col p-0 w-1/2 lg:w-2/3 flex">
        {!! App::getFooterNav() !!}
        <img class="w-full" src="{!! App::getLogoFooter()['url'] !!}" alt="{!! App::getLogoFooter()['alt'] !!}" >
