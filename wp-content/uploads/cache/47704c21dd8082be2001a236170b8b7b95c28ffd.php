    ...
    <div class="thelast md:px-32 lg:px-51 w-full 2xl:pl-190 2xl:pr-140 mt-15 lg:mt-22 xl:px-75 xl:mt-14">
        ...
        <div class="xl:flex  ">
            <div class="h-255 bg-white rounded-4xl shadow-2xl shadow-blue-50 xl:w-full">
                <img class="w-full h-139 lazy" src="<?php echo App::getImgLoading()['url']; ?>" data-src="<?php echo e($data->module['contentl'][0]->imgslast['url']); ?>" alt="<?php echo e($data->module['contentl'][0]->imgslast['alt']); ?>">
