        ...
        <nav class="py-9 row navbar items-center lg:px-26">
            ...
            lg:flex-row lg:justify-end">
                    <li class="menu-item mb-0 ">
                        <a href="<?php echo App::getLogo()['href']; ?>" class="block py-9 lg:py-9 lg:px-15 no-underline" href="#">ABOUT US</a>
                    </li>   
                    <li class="menu-item mb-0">
                        <a class="block py-9 lg:py-9 lg:px-15 no-underline" href="#">LEADERSHIP</a>
                    </li>
                    <li class="menu-item mb-0">
                        <a href="<?php echo App::getLogo()['href']; ?>" class="block py-9 lg:py-9 lg:px-15 no-underline font-semibold" href="#">CAREERS</a>
                    </li>

                    <li class="active menu-item mb-0">
                        <a href="<?php echo App::getLogo()['href']; ?>" class="block py-9 lg:py-9 lg:px-15 no-underline font-semibold" href="#">CONTACT US</a>
                    </li>
                </ul>
