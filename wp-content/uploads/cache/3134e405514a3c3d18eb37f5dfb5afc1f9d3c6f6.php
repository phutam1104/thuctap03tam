<section class="connect lg:flex sm:block sm:mt-21 lg:mt-33 xl:mt-17 2xl:mt-47">
    ...
    <aside class="sm:w-full sm:pt-147 sm:px-5 lg:pt-2 md:px-63 lg:pl-47 lg:pr-51 xl:pl-80 xl:pr-45 2xl:pr-161 static xl:pt-85">
        <h2><?php echo $data->module['titleconnect']; ?></h2>
        <div class="sm:mt-14 lg:mt-8">
          <?php $__currentLoopData = $data->module['contentconnect']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <p><?php echo $item->rowconnect; ?></p>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <a aria-label="Connect" href="<?php echo e($data->module['linkconnect']->url); ?>" target="<?php echo e($data->module['linkconnect']->target); ?>" class="btn btn-brown1 sm:hidden xl:inline-block"><?php echo e($data->module['linkconnect']->title); ?></a>
            </div>
    </aside>
</section>
<?php
// var_dump($data->module['imgconnect']);